...
class TestMitePairer(TestCase):
    ...
    def test_pair_mites_correctly_separates_by_genome_location(self):
        ...
        gene1 = Gene("ABC", "1", "+", "76", "85", "5", "1")
        gene2 = Gene("ABC", "1", "-", "5", "15", "5", "1")
        gene3 = Gene("ABC", "2", "+", "16", "25", "5", "1")
        gene4 = Gene("ABC", "2", "-", "26", "35", "5", "1")
        gene5 = Gene("ABC", "1", "+", "36", "45", "5", "2")
        gene6 = Gene("ABC", "1", "-", "46", "55", "5", "2")
        gene7 = Gene("ABC", "2", "+", "56", "65", "5", "2")
        gene8 = Gene("ABC", "2", "-", "66", "75", "5", "2")
